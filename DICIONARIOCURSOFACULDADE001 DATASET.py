# -*- coding: utf-8 -*-
"""
Created on Tue May 30 13:33:33 2023
...
ncurso, nomeCursos = ListarNomeCurso(DScurso)
print("Puc: ", ncurso, " Cursos")
for i in (nomeCursos):
    print(i)

def CodigoCurso(nm, dscurso):
    for i in(dscurso):
        cd = i["CODIGO"]
        nome = i["NOME"]
        return cd if nome == nm else None